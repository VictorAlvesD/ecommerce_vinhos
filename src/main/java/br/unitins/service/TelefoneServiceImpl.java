...
public class TelefoneServiceImpl implements TelefoneService{
    ...
    private void validarId(Telefone telefone) throws ConstraintViolationException {
        if (telefone.getId() == null)
            throw new NullPointerException("Id inválido");
    }
    @Override
    @Transactional
    public TelefoneResponseDTO insert(TelefoneDTO telefoneDTO) throws ConstraintViolationException {
        validar(telefoneDTO);
    ...
    public void delete(Long id) {
        validarId(telefoneRepository.findById(id));
